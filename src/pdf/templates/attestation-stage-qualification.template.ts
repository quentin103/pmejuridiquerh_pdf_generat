...
export const attestationStageQualificationTemplate: PdfTemplate = {
  name: 'attestation-stage-qualification',
  description: 'Template pour les attestations de stage de qualification professionnelle',
  htmlContent: `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
        ...
        <title>Attestation de Stage de Qualification Professionnelle</title>
    </head>
    <body>
        <div class="document">
            <div class="header">
                <h1>ATTESTATION DE STAGE DE QUALIFICATION PROFESSIONNELLE</h1>
                {{#if reference}}
                <div class="reference">
  ...
  `,
  sampleData: {
    reference: 'ATT/STAGE-QUAL/2024/001',
    declarant: {
      civilite: 'M.',
      nom: 'DUPONT Jean',
    ...
    stagiaire: {
      civilite: 'M.',
      nom: 'MARTIN Paul',
      dateNaissance: new Date('1995-05-20'),
