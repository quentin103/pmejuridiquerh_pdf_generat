// src/pdf/templates/attestation-reprise-service.template.ts
import { PdfTemplate } from '../interfaces/pdf-template.interface';

export const attestationRepriseServiceTemplate: PdfTemplate = {
  name: 'attestation-reprise-service',
  description: 'Template pour les attestations de reprise de service',
  htmlContent: `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
                ...
                <div class="attestation-section">
                    ...
                    <div class="conge-info">
                        <p>
                            ...
                            a bénéficié d'un {{conge.type}} 
                            du <strong>{{formatDate conge.dateDebut}}</strong> 
                            au <strong>{{formatDate conge.dateFin}}</strong>.
                        </p>
                    </div>
                    
                    <div class="reprise-info">
                        <p>
                            {{employe.pronomPersonnel}} a repris le service ce jour 
                            <strong>{{formatDate reprise.date}}</strong> 
                            à <strong>{{reprise.heure}}</strong>.
                        </p>
                    </div>
                </div>
