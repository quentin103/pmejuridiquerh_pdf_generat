...
export const attestationCongesTemplate: PdfTemplate = {
  name: 'attestation-conges',
  description: 'Template pour les attestations de congés payés',
  htmlContent: `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
                ...
                <div class="attestation-section">
                    ...
                    <div class="employee-info">
                        <p>
                            ...
                            matricule employé <strong>{{employe.matricule}}</strong>, 
                            bénéficie de congés payés d'une durée de <strong>{{conge.duree}} jours</strong> 
                    ...
                    <div class="reprise-info">
                        <p>
                            {{employe.pronomPersonnel}} reprendra le service le 
                            <strong>{{formatDate conge.dateReprise}}</strong> 
  ...
  sampleData: {
    ...
    conge: {
      ...
      dateFin: new Date('2024-07-21'),
      dateReprise: new Date('2024-07-22'),
      heureReprise: '08h00'
    },
    lieu: 'Paris',
